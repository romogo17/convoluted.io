...
export const icons = [
  ...
  {
    title: 'Github',
    link: 'https://github.com/romogo17',
    svg:
      '<svg viewBox="0 0 800 800"><path d="M400 139c144 0 260 116 260 260 0 115-75 213-178 247-9 3-17-2-17-13v-71c0-35-18-48-18-48 57-6 119-28 119-128 0-44-27-70-27-70s14-29-2-69c0 0-22-7-72 27-42-12-88-12-130 0-50-34-72-27-72-27-16 40-2 69-2 69s-27 26-27 70c0 100 62 122 119 128 0 0-14 10-17 35-15 7-53 18-76-22 0 0-13-25-39-27 0 0-26 0-2 16 0 0 17 8 29 38 0 0 16 51 88 35v44c0 11-9 16-18 13-103-34-178-132-178-247 0-144 116-260 260-260z"/></svg>',
  },
  // Instagram
  {
    title: 'Instagram',
    link: 'https://instagram.com/romogo17',
    svg:
  ...
  {
    title: 'Twitter',
    link: 'https://twitter.com/romogo17',
    svg:
  ...
  // Youtube
  {
    title: 'Youtube',
    svg:
      '<svg viewBox="0 0 800 800"><path d="M400 224c144 0 201 2 224 25 17 17 26 52.125 26 151s-9 134-26 151c-23 23-80 25-224 25s-201-2-224-25c-17-17-26-52.125-26-151s9-134 26-151c23-23 80-25 224-25zm-52 100v141l135-70z"/></svg>',
  },
  // Facebook
  {
    title: 'Facebook',
  ...
  render() {
    return (
      <div className="social-icons">
        {icons.map((ic, i) => this.renderIcon(ic, i))}
      </div>
    )
  }
