...
image:
    src: https://cdn-images-1.medium.com/max/2600/1*iq8CT4fj77aQWy3d6WpgYQ.png
    alt: Representation of a DB table being normalized?
categories:
    - databases
tags:
    - rdbms
...
At this point, I was a bit confused. Sure, the answer was simple and had some logic in it. But why had he came up with the business rules as the answer? We certainly didn’t ever considered the _business_ itself while following the process before.

## So, why the business rules?

You see, it's interesting how so many people don’t ever consider the business itself while designing a solution, they follow a process but don't realize **_why_** is it done that way, where did it all come from.
...
<small>
    ...
    [here](https://medium.com/@romogo17/understanding-the-meaning-of-table-normalization-bdbc8efb94b4).
</small>
